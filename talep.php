...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-light  text-center py-5">
        <div class="container">
            ...
            <p class="lead">Formu doldurunuz.</p>
        </div>
    </div>
    <!-- File Table -->
    <div class="container">
        <iframe src="https://forms.gle/5ZcT24RBuf5PUbJt5" width="640" height="800" frameborder="0" marginheight="0" marginwidth="0">Yükleniyor…</iframe>
